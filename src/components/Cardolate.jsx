    ...
    <main className="root">
        ...
        {!onlyCard && (
          <section className="controls">
            ...
            <div className="buttons">
              ...
              {!readOnly && !existingId && (
                <button className="btn" onClick={saveCardAndCopyLink}>
                  Get share link
                </button>
              )}
              {!readOnly && existingId && (
                <button className="btn" onClick={updateCard}>
                  Update card
                </button>
              )}
            </div>
      ...
      <style jsx>{`
        ...
        @media (min-width: 1024px) {
          .wrap {
            padding: 40px 20px;
            grid-template-columns: ${onlyCard ? "1fr" : "1fr 1fr"};
            gap: 32px;
          }
        }
        .controls {
        ...
        .card {
          ...
          height: calc(min(92vw, 720px) * 0.64);
        ...
        .front {
          border: 1px solid rgba(247, 195, 77, 0.5);
        }
        .back {
          transform: rotateY(180deg);
          border: 1px solid rgba(247, 195, 77, 0.35);
        }
      `}</style>
    </main>
  );
